...
<html lang="fr">
    ...
    <body>
        <?php include 'e="vertical-align: i.php'; ?>
        ...
        <footer>
            <p>Nous Contacter 07 72 81 89 48</p>
            <p>Créé par Ducom Rudy et Lartigue Corentin</p>
        </footer>
    </body>
</html>
